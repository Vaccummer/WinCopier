...
struct FileOperationSet
{
    ...
    FileOperationSet(bool NoProgressUI = false, bool NoneUI = false, bool NoConfirmation = false, bool NoErrorUI = false, bool NoConfirmationForMakeDir = true, bool WarningIfPermanentDelete = false)
        : NoProgressUI(NoProgressUI), NoneUI(NoneUI), NoConfirmation(NoConfirmation), NoErrorUI(NoErrorUI), NoConfirmationForMakeDir(NoConfirmationForMakeDir), WarningIfPermanentDelete(WarningIfPermanentDelete) {}
};
