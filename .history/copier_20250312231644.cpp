...
public:
        ...
        FileOperationType action)
    {
        ...
        if (FAILED(hr))
        {
            ...
            {
            case FileOperationType::COPY:
                pytrace(AMERROR, "CopyOperationFailed", "ExplorerAPI", "PerformOperations", GetErrorMsg(hr));
                break;
            case FileOperationType::MOVE:
                pytrace(AMERROR, "MoveOperationFailed", "ExplorerAPI", "PerformOperations", GetErrorMsg(hr));
                break;
            }
