...
using OR = std::variant<std::vector<std::pair<std::pair<std::wstring, std::wstring>, FR>>, FR>;
...
public:
    ...
    OR copy(std::vector<std::wstring> srcs, std::wstring dst)
    {
        ...
        if (FAILED(hr))
        {
            ...
            return FileOperationResult::FailToCreDstShellItem;
        }
        ...
        for (auto src : srcs)
        {
            ...
            {
                pDestinationItem->Release();
                return FileOperationResult::PathNotExists;
            }
            ...
            {
                pDestinationItem->Release();
                return FileOperationResult::FailToCreSrcShellItem;
            }
